...
if("TRUE" STREQUAL "TRUE")
  set(optimizer_SOURCE_PREFIX /home/ikutan/catkin_ws/src/optimizer)
  set(optimizer_DEVEL_PREFIX /home/ikutan/catkin_ws/devel)
  ...
  set(optimizer_INSTALL_PREFIX /home/ikutan/catkin_ws/install)
...
if(NOT "/home/ikutan/catkin_ws/src/optimizer/include " STREQUAL " ")
  set(optimizer_INCLUDE_DIRS "")
  set(_include_dirs "/home/ikutan/catkin_ws/src/optimizer/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'optimizer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ikutan/catkin_ws/src/optimizer/${idir}'.  ${_report}")
    endif()
    _list_append_unique(optimizer_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "optimizer;ga")
